...
if($_SERVER['REQUEST_METHOD'] == "POST"){
    ...
    if($num == 1){
        ...
        if(password_verify($login_pass, $row['userpass'])){
            ...
            header("Location: /discusstech/index.php?login=true");
        }
        else{
            header("Location: /discusstech/index.php?login=invalidpass");
        }
    }
    else{
        header("Location: /discusstech/index.php?login=invaliduser");
    }
}
?>