  ...
  <body>        
    ...
    <?php
      ...
      if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        $sql = "INSERT INTO `thread` (`thread_title`, `thread_desc`, `thread_cat_id`, `thread_user_id`, `timestamp`) VALUES ('$new_thread_title', '$new_thread_desc', '$id', '$loggedin_userid', current_timestamp())";
    ...
    <div class="container my-4">
        <div class="bg-black p-5 rounded-lg m-6" style="color:white;" >
            <strong><h1 class="display-4">Welcome to the <?php echo $cat_name ?> Forum</h1></strong>
  ...
  echo '<div class="container">
        <form action="'.$_SERVER['REQUEST_URI'].'" method="post" >
          <div class="form-group">
            ...
            <input type="text" name="threadtitle" class="form-control" id="title">
            <small class="form-text text-muted">Dont Ask unvalid Questions</small>
          </div>
          <div class="form-group">
            <label for="threaddesc">Ellaborate your Question</label>
            <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="threaddesc"></textarea>
          </div>
